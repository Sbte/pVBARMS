...
//        return 0;
        ...
        //                colunms2csptr(n, ia, ja, a, smat);
        //                outputcsmat(smat,"mat.coo",1);
        //        return 0;
        //                int fullmatize(int n, FLOAT *a, int *ja, int *ia, FLOAT *b, int *jb, int*ib, char *type){
        //int fullmatize(int n, int nnz, FLOAT *a, int *ja, int *ia, FLOAT *b, int *jb, int*ib);
...
*/
        ...
        //output_intvectorpa("mapperm",map->lvars,0, nloc);
        /* Free dom and idom */
        free(dom);
        free(idom);
        ...
        //        parms_Viewer v;
        //        parms_ViewerCreate(&v, "foomat");
        //        parms_MatView(self, v);
        //        parms_ViewerFree(&v);
        ...
        if(!nrhs)
        {
            ...
            //            output_dblvectorpa("x",x,0, nloc);
        }
        else
        {
            //output_dblvectorpa("rhstmp",rhstmp,0, n);
            parms_VecSetValues(rhs, n, im, rhstmp, INSERT, map);
            //output_dblvectorpa("rhs",rhs,0, nloc);
            //output_dblvectorpa("rhsinserted",rhs,0, nloc);
            //output_dblvectorpa("rhstmp",rhstmp,0, nloc);
        }
